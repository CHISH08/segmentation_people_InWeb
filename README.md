...
![Пример работы](./img_for_readme/examp.png)  
...
## Особенности
Это не баг, это фича!!!  
![Фича](./img_for_readme/examp.jpg)  

Почему фича? Я описывал [здесь](#особенности-датасета)
...
Праивльный подбор параметров, метрик, лосса также роляет, поэтому уделите этому тоже достаточно времени.
